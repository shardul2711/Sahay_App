...
const SignUpVendor = () => {
  const [form, setForm] = useState({
    ...
    password: '',
    confirmPassword: '',
    type: 'grocery', // Default type value
  });
        ...
        <View className="mb-6">
          ...
          <View className="w-full h-12 px-3 py-2 border border-gray-300 rounded-lg bg-white flex justify-center">
            <Picker
              ...
              style={{ flex: 1, color: form.type ? "#000" : "#9CA3AF" }} // Ensures text is visible
            >
              <Picker.Item label="Select Type" value="" enabled={false} />
              <Picker.Item label="Grocery Shopkeepers" value="grocery" />
              <Picker.Item label="Pharmacy Owner" value="pharmacy" />
              <Picker.Item label="Doctors" value="doctor" />
              <Picker.Item label="Teachers" value="teacher" />
              <Picker.Item label="Cooks" value="cook" />
            </Picker>
          </View>
        </View>
